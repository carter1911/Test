...
const services = [
  {
    ...
    desc: 'Comprehensive outbound lead generation systems combining door-to-door canvassing, digital marketing, and strategic community presence to build a consistent, high-quality pipeline of qualified homeowners.',
    outcomes: ['30–60 qualified leads/month', 'Predictable pipeline fill', 'Measurable cost-per-lead'],
    tier: 'bronze',
    deliverables: ['Canvassing strategy & territory mapping', 'Digital ad setup & management', 'Lead tracking dashboard', 'Weekly pipeline reports'],
  },
  {
    icon: '👥',
  ...
  {
    icon: '🏠',
    title: 'Home Show Management',
    desc: 'Transform trade shows and home expos from passive marketing expenses into your most powerful lead-generation channel. We design your booth strategy, train your team, and build the follow-up system.',
    outcomes: ['3–5x more qualified leads per show', 'Higher booth conversion rate', 'Systematic follow-up pipeline'],
    tier: 'bronze',
    deliverables: ['Booth layout & messaging strategy', 'Show team training', 'Lead capture system', 'Post-show follow-up sequence'],
  },
  {
    icon: '🚀',
    title: 'Done-For-You Canvassing',
    desc: 'We build, manage, and deploy canvassing teams on your behalf — handling recruiting, training, routing, and performance management so you get a fully operational door-to-door lead engine without the overhead.',
    outcomes: ['50–150 knocks/day per rep', 'Consistent pipeline flow', 'Lower cost-per-lead than digital'],
    tier: 'silver',
    deliverables: ['Canvassing team recruitment', 'Script & objection training', 'GPS routing & territory management', 'Daily performance reporting'],
  },
  {
    icon: '🏆',
  ...
  },
  {
    ...
    desc: 'A comprehensive 18-module online learning platform covering mindset, canvassing mastery, sales technique, leadership development, and customer retention — available for your entire team, on-demand.',
    outcomes: ['Scalable team training', '24/7 access for all reps', 'Standardized sales process'],
    tier: 'bronze',
    deliverables: ['12-Module Mindset Program', '6-Module Canvassing Mastery', 'Assessments & certifications', 'Manager progress dashboard'],
  },
  {
    icon: '💼',
