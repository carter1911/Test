...
const tierColors = {
  ...
  SILVER: { bg: 'rgba(192,192,192,0.1)', border: 'rgba(192,192,192,0.25)', text: '#C0C0C0' },
    ...
    <div className="quiz-inner" style={{
      ...
      {!result && (
        <div style={{ marginBottom: '32px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '8px' }}>
            <span style={{ color: '#A0A8B8', fontSize: '13px', fontWeight: 600, letterSpacing: '0.1em', textTransform: 'uppercase' }}>
      ...
      {!result ? (
        ...
        <div>
          ...
          <p style={{ color: '#A0A8B8', fontSize: '15px', lineHeight: 1.7, marginBottom: '24px' }}>
            {result.description}
          </p>
          ...
          <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
            ...
            <button
              ...
              onMouseLeave={e => { e.target.style.borderColor = 'rgba(255,255,255,0.15)'; e.target.style.color = '#A0A8B8' }}
            >
              Retake Quiz
            </button>
          </div>
